export interface BasicShape {
  x: number;
  y: number;
  type: "circle" | "rectangle" | "text" | "image" | "line";
}
...
export type Circle = Omit<
  AllShape,
  "width" | "height" | "url" | "image" | "fontSize" | "content"
>;

export type Rectangle = Omit<
  AllShape,
  "radius" | "url" | "image" | "fontSize" | "content"
>;
